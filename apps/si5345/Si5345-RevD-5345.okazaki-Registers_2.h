 ...
 * Created By:                                         ClockBuilder Pro v4.1
 * [2021-09-22] Timestamp:                                          2021-11-19
 * 11:01:22 GMT+09:00
 *
...
si5345_revd_register_t const
    si5345_revd_registers[SI5345_REVD_REG_CONFIG_NUM_REGS] = {
 ...
 /* End configuration registers */
  ...
  /* Start configuration postamble */
        {0x0514, 0x01}, // SI5345_REVD_REG_CONFIG_NUM_REGS-5
        {0x001C, 0x01}, // SI5345_REVD_REG_CONFIG_NUM_REGS-4
        {0x0540, 0x00}, // SI5345_REVD_REG_CONFIG_NUM_REGS-3
        {0x0B24, 0xC3}, // SI5345_REVD_REG_CONFIG_NUM_REGS-2
        {0x0B25, 0x02}, // SI5345_REVD_REG_CONFIG_NUM_REGS-1
 ...
 * Project File:
 * C:\Users\tgc\Desktop\okazaki\Si5345-RevD-5345-Project.okazaki.slabtimeproj
 * Design ID:          5345
 * Created By:         ClockBuilder Pro v4.1 [2021-09-22]
 * Timestamp:          2021-11-19 11:01:22 GMT+09:00
 *
 * Design Rule Check
 * =================
 * Errors:
 ...
 *
 * Warnings:
 * - For your frequency plan, loop bandwidth above 1.252 kHz may increase output
 * jitter and/or increase peaking
 *
 * Device Grade
 * ============
 * Maximum Output Frequency: 240.474 MHz
 ...
 *    N0 (Zero Delay):
 *       Value: 28
 *       OUT1: 240.474 MHz [ 240 + 237/500 MHz ]
 *       OUT3: 240.474 MHz [ 240 + 237/500 MHz ]
 *       OUT9: 40.079 MHz [ 40 + 79/1000 MHz ]
 *    N1:
 *       Unused
 *    N2:
 *       Unused
 ...
 * below. Refer to the Family Reference Manual for information on registers
 * related to frequency plan.
 *
 ...
 * Airflow:  2 m/s
 *
 * Total Power: 676 mW, On Chip Power: 658 mW, Tj: 37 ��C
 *
 *           Frequency  Format   Voltage   Current     Power
 *         -----------  ------  --------  --------  --------
 * VDD                             1.8 V  111.3 mA    200 mW
 * VDDA                            3.3 V  115.2 mA    380 mW
 * VDDO0        Unused
 * VDDO1   240.474 MHz  LVDS       1.8 V   16.1 mA     29 mW
 * VDDO2        Unused
 * VDDO3   240.474 MHz  LVDS       1.8 V   16.1 mA     29 mW
 * VDDO4        Unused
 * VDDO5        Unused
 * VDDO6        Unused
 * VDDO7        Unused
 * VDDO8        Unused
 * VDDO9    40.079 MHz  LVDS       2.5 V   15.2 mA     38 mW
 *                                        --------  --------
 *                                 Total  273.9 mA    676 mW
 *
 * Note:
 *
 ...
 * Theta_JA*On_Chip_Power. -Overall power includes on-chip power dissipation and
 * adds differential load power dissipation to estimate total power
 * requirements. -Above are estimates only: power and temperature should be
 * measured on your PCB. -Selection of appropriate Theta-JA is required for most
 * accurate estimate. Ideally, select 'User Specified Theta-JA' and enter a
 * Theta-JA value based on the thermal properties of your PCB.
 *
 * Settings
 * ========
 *
 ...
 * 0x00A9[28:0]  LOL_CLR_DELAY_DIV256        3080               0x00000C08
 * 0x00E5[0]     FASTLOCK_EXTEND_MASTER_DIS  0                  0x0
 * 0x00E5[5]     FASTLOCK_EXTEND_EN          0                  0x0
 * 0x00EA[28:0]  FASTLOCK_EXTEND             3073               0x00000C01
 ...
 * 0x0212[47:0]  P1_NUM                      25                 0x000000000019
 ...
 * 0x029D[19:0]  FASTLOCK_DLY_ONLOL          112                0x00070
 * 0x02A9[19:0]  FASTLOCK_DLY_ONSW           153                0x00099
 * 0x02B7[3:2]   LOL_NOSIG_TIME              3                  0x3
 * 0x0302[43:0]  N0_NUM                      60129542144        0x00E00000000
 ...
 * 0x0509[5:0]   BW1_PLL                     41                 0x29
 * 0x050A[5:0]   BW2_PLL                     6                  0x06
 * 0x050B[5:0]   BW3_PLL                     5                  0x05
 ...
 * 0x0510[5:0]   FASTLOCK_BW2_PLL            6                  0x06
 * 0x0511[5:0]   FASTLOCK_BW3_PLL            5                  0x05
 ...
 * 0x053D[4:0]   HSW_COARSE_PM_LEN           11                 0x0B
 ...
 * 0x059E[5:0]   HOLDEXIT_BW1                43                 0x2B
 * 0x059F[5:0]   HOLDEXIT_BW2                6                  0x06
 * 0x05A0[5:0]   HOLDEXIT_BW3                5                  0x05
 ...
 * 0x0949[3:0]   IN_EN                       10                 0xA
 * 0x0949[7:4]   IN_PULSED_CMOS_EN           0                  0x0
 * 0x094A[3:0]   INX_TO_PFD_EN               10                 0xA
 ...
 * 0x0B47[4:0]   OOF_CLK_DIS                 5                  0x05
 * 0x0B48[4:0]   OOF_DIV_CLK_DIS             5                  0x05
