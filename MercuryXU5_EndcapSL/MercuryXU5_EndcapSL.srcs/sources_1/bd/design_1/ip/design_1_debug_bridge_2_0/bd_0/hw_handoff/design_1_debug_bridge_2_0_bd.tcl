...
################################################################
# This is a generated script based on design: bd_04e2
#
...
proc create_root_design { parentCell } {
  ...
  set tap_tck [ create_bd_port -dir O tap_tck ]
  set tap_tdi [ create_bd_port -dir O tap_tdi ]
  set tap_tdo [ create_bd_port -dir I tap_tdo ]
  set tap_tms [ create_bd_port -dir O tap_tms ]
  ...
  connect_bd_net -net axi_jtag_tck [get_bd_ports tap_tck] [get_bd_pins axi_jtag/tck]
  connect_bd_net -net axi_jtag_tdi [get_bd_ports tap_tdi] [get_bd_pins axi_jtag/tdi]
  connect_bd_net -net axi_jtag_tms [get_bd_ports tap_tms] [get_bd_pins axi_jtag/tms]
  ...
  connect_bd_net -net tap_tdo_1 [get_bd_ports tap_tdo] [get_bd_pins axi_jtag/tdo]
