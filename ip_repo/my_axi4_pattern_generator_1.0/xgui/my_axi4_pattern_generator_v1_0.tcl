...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_AXI_BURST_LEN" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.C_S_AXI_BURST_LEN { PARAM_VALUE.C_S_AXI_BURST_LEN } {
	# Procedure called to update C_S_AXI_BURST_LEN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_BURST_LEN { PARAM_VALUE.C_S_AXI_BURST_LEN } {
	# Procedure called to validate C_S_AXI_BURST_LEN
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_AXI_BURST_LEN { MODELPARAM_VALUE.C_S_AXI_BURST_LEN PARAM_VALUE.C_S_AXI_BURST_LEN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_BURST_LEN}] ${MODELPARAM_VALUE.C_S_AXI_BURST_LEN}
}
