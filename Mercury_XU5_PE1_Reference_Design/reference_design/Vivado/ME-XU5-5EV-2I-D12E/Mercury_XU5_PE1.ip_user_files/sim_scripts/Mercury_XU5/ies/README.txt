...
#
# Generated by export_simulation on Tue Nov 02 15:23:14 JST 2021
#
################################################################################
...
'-reset_run' switch to the './Mercury_XU5.sh' script.

./Mercury_XU5.sh -reset_run
...
./Mercury_XU5.sh -noclean_files

For more information on the script, please type './Mercury_XU5.sh -help'.
